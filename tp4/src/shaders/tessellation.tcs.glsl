...
void main()
{
    ...
    float distances[4];
    distance[0] = lenght(modelView * centre[0]);
    distance[1] = lenght(modelView * centre[1]);
    distance[2] = lenght(modelView * centre[2]);
    distance[3] = lenght(modelView * centre[3]);
    ...
    gl_TessLevelOuter[0] = mix(MIN_TESS, MAX_TESS, facterMix[0]);
    gl_TessLevelOuter[1] = mix(MIN_TESS, MAX_TESS, facterMix[1]);
    gl_TessLevelOuter[2] = mix(MIN_TESS, MAX_TESS, facterMix[2]);
    gl_TessLevelOuter[3] = mix(MIN_TESS, MAX_TESS, facterMix[3]);
